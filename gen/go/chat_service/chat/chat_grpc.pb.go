...
type ChatServiceClient interface {
	...
	ReceiveMessages(ctx context.Context, in *UserStreamRequest, opts ...grpc.CallOption) (ChatService_ReceiveMessagesClient, error)
}
...
func (c *chatServiceClient) ReceiveMessages(ctx context.Context, in *UserStreamRequest, opts ...grpc.CallOption) (ChatService_ReceiveMessagesClient, error) {
	stream, err := c.cc.NewStream(ctx, &ChatService_ServiceDesc.Streams[0], "/chatservice.ChatService/ReceiveMessages", opts...)
	if err != nil {
		return nil, err
	}
...
type ChatServiceServer interface {
	...
	ReceiveMessages(*UserStreamRequest, ChatService_ReceiveMessagesServer) error
...
func (UnimplementedChatServiceServer) ReceiveMessages(*UserStreamRequest, ChatService_ReceiveMessagesServer) error {
